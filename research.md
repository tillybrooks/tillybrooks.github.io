...
In this project, I explore the nature of racially discriminatory language (RDL) from the perspective of both law and linguistics.  I aim to propose a typology of RDL and empirically examine the phenomenon, with a focus on coded language such as animal comparisons, physical descriptions, and geographic references.

<hr class="project-divider">

#### Unordinary Meaning: The Relevance of Linguistic Variation to Statutory Interpretation
In previous work, I offered evidence that linguistic variation can be relevant to statutory interpretation. In this project, I aim to offer a larger-scale analysis and more in-depth theoretical discussion of why linguistic variation is so important to consider in the process of interpreting the law.
